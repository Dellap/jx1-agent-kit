...
--===========================================================
if _ts > 0 then
    if TradeStayClear and tbNpc.finalIndex and tbNpc.finalIndex > 0 then
        TradeStayClear(tbNpc.finalIndex)
    end

    tbNpc.tradeStayDeadline = nil
    tbNpc.tradeStayBye = nil
    tbNpc.tradeStayByeUntil = nil
    tbNpc.tradePostUntil = nil
    tbNpc.greetStayDeadline = nil
    tbNpc.tradeItemSent = nil
    tbNpc.tradeItemAt = nil

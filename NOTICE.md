...
- `skills/jx1-hqvl-knowledge/` và (nguồn gốc: nhóm HQVL) được tổng hợp từ các repo của HQVL:
...
- `skills/vltk-*`, `skills/jx1-simbot`, `skills/CHEATSHEET.md`, `START-HERE.md`, (file của mod — có sẵn trong bản cài của bạn):
...
- Đường dẫn riêng của máy (alias `ssh <SSH_ALIAS>`, `<GAME_ROOT>\...`) là ví dụ, cần sửa theo môi trường của bạn.
